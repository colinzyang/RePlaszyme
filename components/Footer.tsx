                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 lg:gap-10 mb-10">
                    ...
                    <div className="md:col-span-5 space-y-4">
                        ...
                        <div className="flex items-center gap-2 pt-2">
                             ...
                             <a href="https://teams.igem.org/5580" target="_blank" rel="noreferrer" className="w-8 h-8 flex items-center justify-center rounded-lg border border-slate-200 text-slate-400 hover:border-[#009b48] hover:text-[#009b48] hover:bg-emerald-50 transition-all" title="iGEM">
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
